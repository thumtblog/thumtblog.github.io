...
<br>
<!-- 图1：多源端序列生成类任务 -->
<div align="center"><img src="{{ site.url }}/images/TRICE/fig1.png" width=600></div>
...
<br>
<!-- 图2：我们的工作与前人工作的区别 -->
<div align="center"><img src="{{ site.url }}/images/TRICE/tab1.png" width=450></div>
...
In this paper, we propose a two-stage finetuning method named *gradual finetuning*. Different from prior studies, our work aims to transfer pretrained Seq2Seq models to MSG (see Table 1).
...
<br>
<!-- 图4：我们的模型架构 -->
<div align="center"><img src="{{ site.url }}/images/TRICE/fig3.png" width=600></div>
...
We evaluated our framework on three MSG tasks: (1) automatic post-editing, (2) multi-source translation, and (3) document-level translation.

Experiments show that our approach achieves new state-of-the-art results on the WMT17 APE task and multi-source translation task using the WMT14 test set. When adapted to document-level translation, our framework outperforms strong baselines significantly. 
